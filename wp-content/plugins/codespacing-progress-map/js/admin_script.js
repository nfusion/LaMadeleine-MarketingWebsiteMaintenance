...
jQuery(document).ready(function($){ 
	...
	$('label[id=codespacingprogressmap_layoutsettings_main_layout_m-con], label[id=codespacingprogressmap_layoutsettings_main_layout_fit-in-map-top-carousel], label[id=codespacingprogressmap_layoutsettings_main_layout_fullscreen-map-top-carousel]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/map-c-top.png" />'
	});		
	...
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_square_bubble]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/square_bubble.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_rounded_bubble]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/rounded_bubble.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type1]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/infobox_1.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type2]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/infobox_2.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type3]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/infobox_3.jpg" />'
	});		
	
	$('label[id=codespacingprogressmap_infoboxsettings_infobox_type_cspm_type4]').qtip({
	  style: 'mystyle',
	  content: '<img src="'+cspacing_admin_vars.plugin_url+'img/tooltips/infobox_4.jpg" />'
	});		
	...
	$("#cspm_form").validate({
		...
		rules: {
			...
			"codespacingprogressmap_settings[codespacingprogressmap_markeroverlaysettings_content_overlay_horizontal_pos]": "required",
			"codespacingprogressmap_settings[codespacingprogressmap_markeroverlaysettings_content_overlay_vertical_pos]": "required",
			"codespacingprogressmap_settings[codespacingprogressmap_markeroverlaysettings_bubble_horizontal_pos]": "required",
			"codespacingprogressmap_settings[codespacingprogressmap_markeroverlaysettings_bubble_vertical_pos]": "required",
